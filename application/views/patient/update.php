    ...
    <div id="body">
        ...
        <div class="content">
            ...
            <label for="last"><span>Lastname:</span>
                <input type="text" name="lastname" id="last" value="<?php echo set_value('lastname',ucfirst($result['lastname']))?>" placeholder="Please enter patient's last name" required>
                <?php echo form_error('lastname',"<div class='error'>",'</div>')?>
            </label>
            <label for="age"><span>Age:</span>
                <input type="number" name="age" id="age" value="<?php echo set_value('age',$result['age'])?>" min = "0" max="120" placeholder="Please enter patient's age" required>
            ...
            <label for="ssn"><span>Social Security Number:</span>
                <input type="text" name="ssn" id="ssn" value="<?php echo set_value('ssn',$result['ssn'])?>" placeholder="Please enter patient's SSN" required>
                <?php echo form_error('ssn',"<div class='error'>",'</div>')?>
            </label>
            <label for="phone"><span>Phone number:</span>
                <input type="text" name="telephone" id="phone" value="<?php echo set_value('telephone',$result['telephone'])?>" placeholder="Phone number format x-xxx-xxx-xxxx" required>
                <?php echo form_error('telephone',"<div class='error'>",'</div>')?>
            </label>
            <label for="email"><span>Email address:</span>
                <input type="email" name="email" id="email" value="<?php echo set_value('email',$result['email'])?>" placeholder="Please enter patient's email" required>
